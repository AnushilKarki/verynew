...
class CreateFinancialHeadReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('financial_head_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('financial_head_reports');
    }
}
