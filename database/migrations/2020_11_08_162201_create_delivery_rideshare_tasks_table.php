...
class CreateDeliveryRidesharesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('delivery_rideshares', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('delivery_id')->references('id')->on('delivery_rides')->onDelete('cascade')->nullable();
    ...
    {
        Schema::dropIfExists('delivery_rideshares');
    }
}
