...
class CreateDeliveryRidesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('delivery_rides', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('time',['morning','day','evening','night'])->default('day');
    ...
    {
        Schema::dropIfExists('delivery_rides');
    }
}
