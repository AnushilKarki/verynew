...
class CreateDeliveryHeadReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('delivery_head_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('delivery_head_reports');
    }
}
