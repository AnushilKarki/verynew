...
class CreateCourierDeliveryTasksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('courier_delivery_tasks', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('courier_delivery_tasks');
    }
}
