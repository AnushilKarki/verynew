...
class CreateCeoReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ceo_reports', function (Blueprint $table) {
            $table->id(); 
            ...
            $table->integer('total_marketing_task_completed');
            $table->integer('total_marketing_task_failed');
            $table->integer('total_service_task_completed');
            $table->integer('total_service_task_failed');
            $table->integer('total_delivery_task_completed');
            $table->integer('total_delivery_task_failed');
    ...
    {
        Schema::dropIfExists('ceo_reports');
    }
}
