...
class CreateCustomerServiceHeadReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('customer_service_head_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('customer_service_head_reports');
    }
}
