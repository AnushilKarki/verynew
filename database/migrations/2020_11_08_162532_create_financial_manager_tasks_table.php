...
class CreateFinancialManagerTasksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('financial_manager_tasks', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('financial_manager_tasks');
    }
}
