...
class CreateMarketingHeadReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('marketing_head_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('marketing_head_reports');
    }
}
